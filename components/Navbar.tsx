...
import { FaGithub, FaMailBulk, FaTelegram, FaTiktok, FaTwitter, FaYoutube } from 'react-icons/fa'
...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full h-[100px] shadow-xl bg-white/5 z-[100]'>
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
            <Link href='/'><Image src="/logo.png" alt="/" width='75' height='75' className='rounded-full' /></Link>
                <h2><Link href='/'><span className="font-bold text-center -ml-8 md:ml-6 text-transparent bg-clip-text bg-gradient-to-r from-[#576ad2] to-[#b075e7]">Javahound</span></Link></h2>
                <div>
            ...
            <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70 z-0' : ''}>
                <div className={nav ? 'md:hidden fixed left-0 top-0 w-[80%] sm:w-[65%] md:w-[45%] h-screen bg-[#383742] p-10 ease-in duration-500' : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'}>
                    <div>
                    ...
                    <div className='py-4 flex flex-col'>
                        ...
                        <div className='pt-40'>
                            ...
                            <div className='flex items-center justify-between mt-8 w-[100%] sm:w-[100%] md:w-[60%] sm:pl-12 sm:pr-12'>
